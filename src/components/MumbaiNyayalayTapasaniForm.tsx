  ...
  const handleSubmit = async (isDraft: boolean = false) => {
    try {
      ...
      if (editingInspection && editingInspection.id) {
        ...
        // Upsert mumbai_high_court_school_inspection_form record
        const { error: formError } = await supabase
          .from('mumbai_high_court_school_inspection_form')
          .upsert({
            inspection_id: editingInspection.id,
            inspection_date: mumbaiNyayalayFormData.inspection_date,
            district_name: mumbaiNyayalayFormData.district_name,
            taluka_name: mumbaiNyayalayFormData.taluka_name,
            center_name: mumbaiNyayalayFormData.center_name,
            school_name: mumbaiNyayalayFormData.school_name,
            management_name: mumbaiNyayalayFormData.management_name,
            headmaster_name: mumbaiNyayalayFormData.principal_name,
            udise_number: mumbaiNyayalayFormData.udise_number,
            total_boys_count: mumbaiNyayalayFormData.total_boys,
            total_girls_count: mumbaiNyayalayFormData.total_girls,
            total_student_count: mumbaiNyayalayFormData.total_students,
            approved_teacher_count: mumbaiNyayalayFormData.sanctioned_teachers,
            working_teacher_count: mumbaiNyayalayFormData.working_teachers,
            vacant_teacher_count: mumbaiNyayalayFormData.vacant_teachers,
            approved_nonteaching_staff_count: mumbaiNyayalayFormData.sanctioned_non_teaching,
            working_nonteaching_staff_count: mumbaiNyayalayFormData.working_non_teaching,
            vacant_nonteaching_staff_count: mumbaiNyayalayFormData.vacant_non_teaching,
            serial_number: 1,
            details: 'Mumbai High Court School Inspection',
            current_status: mumbaiNyayalayFormData.building_construction_year_status || '',
            action_to_be_taken: mumbaiNyayalayFormData.building_construction_year_measures || '',
            remarks: mumbaiNyayalayFormData.building_construction_year_feedback || '',
            school_building_construction_year: mumbaiNyayalayFormData.building_construction_year || '',
            school_building_type: mumbaiNyayalayFormData.building_type_structure || '',
            rcc_construction: mumbaiNyayalayFormData.building_type_structure?.includes('आर.सी.सी') || false,
            sheet_roofed_or_tiled_building: mumbaiNyayalayFormData.building_type_structure?.includes('पत्र्याचे') || false,
            school_building_condition: mumbaiNyayalayFormData.building_type_structure_status || '',
            well_maintained: mumbaiNyayalayFormData.building_type_structure_status?.includes('सुस्थितीत') || false,
            repairs_needed: mumbaiNyayalayFormData.building_type_structure_status?.includes('दुरुस्ती') || false,
            if_repairs_what_repair: mumbaiNyayalayFormData.building_type_structure_measures || '',
            classrooms_available_as_per_student_count: mumbaiNyayalayFormData.classrooms_adequate_status?.includes('होय') || false,
            required_classroom_count: parseInt(mumbaiNyayalayFormData.classrooms_adequate_status?.match(/आवश्यक.*?(\d+)/)?.[1] || '0') || 0,
            available_classroom_count: parseInt(mumbaiNyayalayFormData.classrooms_adequate_status?.match(/उपलब्ध.*?(\d+)/)?.[1] || '0') || 0,
            newly_required_classroom_count: parseInt(mumbaiNyayalayFormData.classrooms_adequate_status?.match(/नव्याने.*?(\d+)/)?.[1] || '0') || 0,
            classrooms_safe: mumbaiNyayalayFormData.classrooms_adequate_status?.includes('सुरक्षित') || false,
            repairs_required: mumbaiNyayalayFormData.classrooms_adequate_status?.includes('दुरुस्ती') || false,
            if_repairs_what_repair_classrooms: mumbaiNyayalayFormData.classrooms_adequate_measures || '',
            separate_toilet_for_boys_and_girls: mumbaiNyayalayFormData.separate_toilets_status?.includes('होय') || false,
            toilets_available_as_per_student_number: mumbaiNyayalayFormData.separate_toilets_status?.includes('प्रमाणात') || false,
            toilets_cleaned_regularly: mumbaiNyayalayFormData.separate_toilets_status?.includes('स्वच्छता') || false,
            basic_water_facility_in_toilets: mumbaiNyayalayFormData.separate_toilets_status?.includes('पाण्याची') || false,
            cwsn_toilet_available: mumbaiNyayalayFormData.cwsn_toilets_status?.includes('होय') || false,
            cwsn_toilet_cleaned_regularly: mumbaiNyayalayFormData.cwsn_toilets_status?.includes('स्वच्छता') || false,
            basic_water_facility_in_cwsn_toilet: mumbaiNyayalayFormData.cwsn_toilets_status?.includes('पाण्याची') || false,
            drinking_and_usage_water_available: mumbaiNyayalayFormData.drinking_water_status?.includes('होय') || false,
            water_tank_available: mumbaiNyayalayFormData.drinking_water_status?.includes('टाकी') || false,
            tank_capacity_litres: parseInt(mumbaiNyayalayFormData.drinking_water_status?.match(/(\d+).*?लिटर/)?.[1] || '0') || 0,
            water_storage_type: mumbaiNyayalayFormData.drinking_water_status?.match(/(पिपा|जार|टाकी)/)?.[1] || '',
            tank_cleaned: mumbaiNyayalayFormData.drinking_water_status?.includes('स्वच्छता') || false,
            tank_cleaning_interval: mumbaiNyayalayFormData.drinking_water_status?.match(/(\d+).*?दिवस/)?.[1] || '',
            school_has_compound: mumbaiNyayalayFormData.boundary_wall_status?.includes('होय') || false,
            compound_type: mumbaiNyayalayFormData.boundary_wall_status?.match(/(पक्की|तारेचे)/)?.[1] || '',
            compound_well_maintained: mumbaiNyayalayFormData.boundary_wall_status?.includes('सुस्थितीत') || false,
            playground_available: mumbaiNyayalayFormData.playground_status?.includes('होय') || false,
            playground_condition: mumbaiNyayalayFormData.playground_status || '',
            playground_ownership: mumbaiNyayalayFormData.playground_status?.match(/(स्वतःचे|खाजगी|सार्वजनिक)/)?.[1] || '',
            playground_area: mumbaiNyayalayFormData.playground_status?.match(/क्षेत्रफळ.*?([^\s]+)/)?.[1] || '',
            kitchen_shed_available_and_condition: mumbaiNyayalayFormData.kitchen_shed_status || '',
            kitchen_shed_clean: mumbaiNyayalayFormData.kitchen_shed_status?.includes('स्वच्छ') || false,
            ramp_available: mumbaiNyayalayFormData.ramp_facility_status?.includes('होय') || false,
            ramp_meets_standard: mumbaiNyayalayFormData.ramp_facility_status?.includes('निकषा') || false,
            both_sides_with_railings: mumbaiNyayalayFormData.ramp_facility_status?.includes('कठडे') || false,
            lighting_facility_available: mumbaiNyayalayFormData.electricity_status?.includes('होय') || false,
            electricity_in_all_classrooms: mumbaiNyayalayFormData.electricity_status?.includes('सर्व खोल्यां') || false,
            power_disconnected_due_to_nonpayment: mumbaiNyayalayFormData.electricity_status?.includes('बंद') || false,
            classrooms_needing_electricity_or_repairs: parseInt(mumbaiNyayalayFormData.electricity_status?.match(/(\d+).*?खोल्यां/)?.[1] || '0') || 0,
            fans_and_lights_wellmaintained: mumbaiNyayalayFormData.electricity_status?.includes('सुस्थितीत') || false,
            seating_arrangement_for_students: mumbaiNyayalayFormData.seating_arrangement_status || '',
            benches_available: parseInt(mumbaiNyayalayFormData.seating_arrangement_status?.match(/उपलब्ध.*?(\d+)/)?.[1] || '0') || 0,
            benches_required: parseInt(mumbaiNyayalayFormData.seating_arrangement_status?.match(/आवश्यक.*?(\d+)/)?.[1] || '0') || 0,
            benches_shortage: parseInt(mumbaiNyayalayFormData.seating_arrangement_status?.match(/कमी.*?(\d+)/)?.[1] || '0') || 0,
            benches_condition: mumbaiNyayalayFormData.seating_arrangement_feedback || '',
            is_school_and_premises_clean: mumbaiNyayalayFormData.cleanliness_status?.includes('होय') || false,
            classroom_clean: mumbaiNyayalayFormData.cleanliness_status?.includes('वर्ग खोल्या') || false,
            building_clean: mumbaiNyayalayFormData.cleanliness_status?.includes('इमारत') || false,
            playground_or_premises_clean: mumbaiNyayalayFormData.cleanliness_status?.includes('मैदान') || false,
            classroom_painted: mumbaiNyayalayFormData.cleanliness_status?.includes('रंगरंगोटी') || false,
            classroom_used_only_for_education: !mumbaiNyayalayFormData.cleanliness_status?.includes('इतर कामां') || false,
            if_other_use_details: mumbaiNyayalayFormData.cleanliness_measures || '',
            school_or_premises_used_for_illegal_activities: mumbaiNyayalayFormData.illegal_use_status?.includes('होय') || false,
            law_and_order_issue: mumbaiNyayalayFormData.illegal_use_status?.includes('कायदा') || false,
            requires_police_action: mumbaiNyayalayFormData.illegal_use_status?.includes('पोलिस') || false,
            encroachment_on_school_building_or_land: mumbaiNyayalayFormData.encroachment_status?.includes('होय') || false,
            if_encroached_description: mumbaiNyayalayFormData.encroachment_measures || '',
            noteworthy_work_on_facilities_or_other_matters: mumbaiNyayalayFormData.notable_work_status || ''
          });
        ...
        // Create mumbai_high_court_school_inspection_form record
        const { error: formError } = await supabase
          .from('mumbai_high_court_school_inspection_form')
          .insert({

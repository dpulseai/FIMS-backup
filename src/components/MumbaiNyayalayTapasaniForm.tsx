...
const inspectionPoints = [
  ...
  // 2. Building Type
  {
    key: 'building_type_structure_a',
    title: '2] (अ) शाळा बांधकाम प्रकार :'
  },
  {
    key: 'building_type_structure_a1',
    title: '   1. आर.सी.सी. बांधकाम'
  },
  {
    key: 'building_type_structure_a2',
    title: '   2. पत्र्याचे बांधकाम / कौलारू बांधकाम'
  },
  {
    key: 'building_type_structure_b',
    title: '2] (ब) शाळा बांधकाम स्थिती :'
  },
  {
    key: 'building_type_structure_b1',
    title: '   1. सुस्थितीत आहे काय ?'
  },
  {
    key: 'building_type_structure_b2',
    title: '   2. दुरुस्तीची गरज आहे का ? असल्यास काय दुरुस्ती'
  },

  // 3. Classrooms
  {
    key: 'classrooms_adequate',
    title: '3] विद्यार्थ्यांच्या प्रमाणात वर्ग खोल्या आहेत का ?'
  },
  {
    key: 'classrooms_adequate_1',
    title: '   1. आवश्यक खोल्यांची संख्या.'
  },
  {
    key: 'classrooms_adequate_2',
    title: '   2. उपलब्ध खोल्यांची संख्या.'
  },
  {
    key: 'classrooms_adequate_3',
    title: '   3. नव्याने आवश्यक असणाऱ्या खोल्यांची संख्या.'
  },
  {
    key: 'classrooms_adequate_4',
    title: '   4. खोल्या सुस्थितीत आहे का ?'
  },
  {
    key: 'classrooms_adequate_5',
    title: '   5. दुरुस्ती आवश्यक आहे का ? असल्यास काय दुरुस्ती ?'
  },

  // 4. Toilets
  {
    key: 'separate_toilets',
    title: '4] मुलांसाठी व मुलींसाठी स्वतंत्र स्वच्छतागृह उपलब्ध आहे का ?'
  },
  {
    key: 'separate_toilets_1',
    title: '   1. विद्यार्थी संख्येच्या प्रमाणात स्वच्छतागृहे उपलब्ध आहे का ?'
  },
  {
    key: 'separate_toilets_2',
    title: '   2. शौचालयांची नियमित स्वच्छता होते का ?'
  },
  {
    key: 'separate_toilets_3',
    title: '   3. शौचालयांमध्ये पाण्याची मुलभूत सोय आहे का ?'
  },

  // 5. CWSN Toilets
  {
    key: 'cwsn_toilet',
    title: '5] विशेष गरजा असणाऱ्या विद्यार्थ्यांसाठी (CWSN) स्वच्छतागृह आहे का ? १. शौचालयाची नियमित स्वच्छता होते का ?'
  },

{
    key: 'cwsn_toilets_1',
    title: '   1.शौचालयाची नियमित स्वच्छता होते का ?'
  },

{
    key: 'cwsn_toilets_2',
    title: '  २. शौचालयामध्ये पाण्याची मुलभूत सोय आहे का ?'
  },

  // 6. Drinking and Usage Water
  {
    key: 'drinking_usage_water',
    title: '6] मुलांना पिण्याचे स्वच्छ पाणी व वापरासाठी पाणी पुरेशा प्रमाणात उपलब्ध आहे काय ?'
  },
  {
    key: 'drinking_usage_water_1',
    title: '   1.पाणी साठवण्यासाठी टाकी उपलब्ध आहे का ? असल्यास क्षमता (लिटर मध्ये)'
  },
  {
    key: 'drinking_usage_water_2',
    title: '   2.पाणी साठवणुकीच्या प्रकार (पिपा, जार, इ.)'
  },
  {
    key: 'drinking_usage_water_3',
    title: '   3. पाणी साठवणुकीच्या टाकीची स्वच्छता करणेत येते का? किती दिवसांनी ?'
  },

  // 7. Protective Wall
  {
    key: 'protective_wall',
    title: '7] शाळेला संरक्षक भिंत आहे का ?'
  },

{
    key: 'protective_wall_1',
    title: '१. पक्की भिंत / तारेचे कुंपण ?'
  },

{
    key: 'protective_wall_2',
    title: '२. संरक्षक भिंत सुस्थितीत आहे का ?'
  },

  // 8. Playground
  {
    key: 'playground',
    title: '8] मुलांना खेळण्यासाठी मैदान'
  },

{
    key: 'playground_1',
    title: '१. मैदानाची स्थिती'
  },
{
    key: 'playground_2',
    title: '२. स्वतःचे / खाजगी जागा / सार्वजनिक'
  },
{
    key: 'playground_3',
    title: '३. क्षेत्रफळ किती ?'
  },

  // 9. Kitchen Shed
  {
    key: 'kitchenshed',
    title: '9] किचनशेड उपलब्ध आहे का ? व सद्यस्थिती.'
  },
{
    key: 'kitchenshed_1',
    title: '१. स्वच्छता आहे का ?'
  },

  // 10. Ramp
  {
    key: 'ramp',
    title: '10] उताराचा रस्ता (रॅम्प) आहे का ?'
  },
{
    key: 'ramp_1',
    title: '१. निकषा प्रमाणे आहे का ? (उतार १:१२)'
  },
{
    key: 'ramp_2',
    title: '२. दोन्ही बाजूस कठडे आहेत का ?'
  },
  ...
  {
    key: 'electricity',
    title: '11] शाळेमध्ये लाईटची सोय आहे का ?'
  },

{
    key: 'electricity_1',
    title: '१. सर्व खोल्यांमध्ये वीज उपलब्ध आहे का ?'
  },
{
    key: 'electricity_2',
    title: '२. वीज बिल भरणा न केल्यामुळे बंद आहे काय ?'
  },
{
    key: 'electricity_3',
    title: '३. वीज जोडणी / दुरुस्ती आवश्यक असणाऱ्या खोल्यांची संख्या.'
  },
{
    key: 'electricity_4',
    title: '४. शाळेचे पंखे व लाईट्स सुस्थितीत आहेत का ?'
  },
  ...
  // 12. Seating Arrangement
  {
    ...
    title: '12] विद्यार्थ्यांना बसण्यासाठी बैठक व्यवस्था.'
  },
  {
    key: 'seating_arrangement_1',
    title: '   1.१. बेंचवर / फरशीवर / जमिनीवर'
  },
  {
    key: 'seating_arrangement_2',
    title: '२. उपलब्ध बेंच संख्या'
  },
{
    key: 'seating_arrangement_3',
    title: ' ३. आवश्यक बेंच संख्या'
  },
{
    key: 'seating_arrangement_4',
    title: ' ४. कमी असणाऱ्या बेंच संख्या'
  },
{
    key: 'seating_arrangement_5',
    title: '५. मुलांना बसण्याचे बेंचची स्थिती काय आहे?'
  },
  ...
  {
    key: 'cleanliness',
    title: '13] शाळा व शाळा परिसर स्वच्छ आहे का?'
  },
  {
    key: 'cleanliness_1',
    title: ' १. वर्ग खोल्या'
  ...
  {
    key: 'cleanliness_3',
    title: ' ३. मैदान / शाळेचा परिसर'
  },
{
    key: 'cleanliness_4',
    title: '४. वर्गखोल्यांची रंगरंगोटी आहे का ?'
  },
{
    key: 'cleanliness_5',
    title: '५. वर्गखोल्यांचा वापर शैक्षणिक कामकाजासाठीच होतो का ? इतर कामांसाठी उदा. शेळ्या बांधणे, स्टोअर रूम, अन्य व्यक्तीने अतिक्रमण इत्यादी'
  },

  // 14. Illegal Use
  {
    key: 'illegal_use',
    title: '14] शाळा इमारतींचा / शाळा परिसराचा वापर नागरिकांकडून अवैध कामांसाठी करण्यात येतो का ?'
  },
 {
    key: 'illegal_use_1',
    title: '१. कायदा व सुव्यवस्थेचा प्रश्न उद्भवतो का ? पोलिस प्रशासनाने दखल घेऊन बंदोबस्त करणे आवश्यक आहे का ?'
  },

...
export const createPahuvaidhakiyaForm = async (formData: any): Promise<any> => {
  if (!isSupabaseConfigured || !supabase) {
    throw new Error('Supabase client not initialized');
  }
  ...
  try {
    ...
    console.error('Error creating pahuvaidhakiya form:', error);
    throw error;
  }
};

export const updatePahuvaidhakiyaForm = async (inspectionId: string, formData: any): Promise<any> => {
  if (!isSupabaseConfigured || !supabase) {
    throw new Error('Supabase client not initialized');
  }
  ...
  try {
    ...
    console.error('Error updating pahuvaidhakiya form:', error);
    throw error;
  }
};

export const getPahuvaidhakiyaForm = async (inspectionId: string): Promise<any> => {
  if (!isSupabaseConfigured || !supabase) {
    throw new Error('Supabase client not initialized');
  }
  ...
  try {
    ...
    console.error('Error fetching pahuvaidhakiya form:', error);
    throw error;
  }
};